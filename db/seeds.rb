...
100.times {Trip.create(create_by: Faker::Name.name, trip_date: DateTime.now, title: Faker::Name.name, description: Faker::Name.name, upvotes:0, shares:0, public: true, parent: rand(20))}